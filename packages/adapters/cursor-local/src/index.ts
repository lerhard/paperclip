...
export const agentConfigurationDoc = `# cursor config

Core fields:
- cwd (string, optional): working directory
- instructionsFilePath (string, optional): markdown instructions file path
- promptTemplate (string, optional)
- model (string, optional): e.g. auto, gpt-5.3-codex
- mode (string, optional): plan|ask
- command (string, optional): default "agent"
