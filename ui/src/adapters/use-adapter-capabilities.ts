...
const KNOWN_DEFAULTS: Record<string, AdapterCapabilities> = {
  ...
  openai_proxy: { supportsInstructionsBundle: false, supportsSkills: true, supportsLocalAgentJwt: true, requiresMaterializedRuntimeSkills: false, supportsModelProfiles: false },
