...
export function KimiConfigFields({
  isCreate,
  values,
  set,
  config,
  ...
  return (
    <>
      <Field label="Model" hint="Kimi model ID (default: moonshot-v1-8k)">
        <DraftInput
          value={
            isCreate
              ? v?.model ?? ""
      ...
      <Field label="Temperature" hint="Sampling temperature 0-1 (default: 0.7)">
        <DraftInput
          type="number"
          value={
            isCreate
